...
<style>
	...
	.contentTop{
		width:100%;
		background:url("${pageContext.request.contextPath}/resources/images/menu05_03_topBg.jpg") no-repeat 100%;
		padding:40px;
		height:305px;
	}
	.contentTop > h2{
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									...
									<td class="title"><a href="${pageContext.request.contextPath}/menu5_3Read${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
									<td>${item.writer}</td>
