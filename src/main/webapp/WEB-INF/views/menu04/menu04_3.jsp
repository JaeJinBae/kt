...
<style>
	...
	.contentTop{
		width:100%;
		background:url("${pageContext.request.contextPath}/resources/images/menu04_03_topBg.jpg") no-repeat 100%;
		padding:40px;
		height:305px;
	}
	.contentTop > h2{
...
<body>
	...
	<section>
		<div class="wrapper">
			<h1 class="contentTitle">Sea Black Box</h1>
			<div class="sideMenu">
				<h3>특화솔루션</h3>
				<ul>
			...
			<div class="contentWrap">
				<div class="contentTop">
					...
					<p class="text2">200만화소 해상전용 카메라, 영상녹화장치(DVR) 및 kt LTE 통신망을 통해 원격에서 PC(웹),</p>
					<p class="text2">태블릿 PC, 스마트폰으로 실시간영상 확인 및 저장영상 재생이 가능한 선박에 특화된 </p>
					<p class="text2">영상보안서비스</p>
				</div>
				<div class="subTitle">
					<h3>주요 서비스</h3>
				</div>
				...
				<div class="content04">
					<img src="${pageContext.request.contextPath}/resources/images/menu04_03service.jpg">
				</div><!-- content04 end -->
				<div class="subTitle">
					<h3>A/S 프로세스</h3>
				</div>
				<div class="content05">
					<img src="${pageContext.request.contextPath}/resources/images/menu04_03process.jpg">
				</div><!-- content04 end -->
			</div><!-- contentWrap end -->
		</div><!-- wrapper end -->
		<div class="footer">
