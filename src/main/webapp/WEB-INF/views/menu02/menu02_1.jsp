...
<style>
	...
	.contentTop{
		width:100%;
		background:url("${pageContext.request.contextPath}/resources/images/menu02_01_topBg.jpg") no-repeat 100%;
		padding:40px;
		height:305px;
	}
	.contentTop > h2{
		...
		<div class="wrapper">
			...
			<div class="contentWrap">
				<div class="contentTop">
					...
					<p class="text2">빌딩의 안전을 지키는 방법서비스는 물론 빌딩에 근무하는 직원들의</p>
					<p class="text2">편리한 업무환경을 보장하는 통합관리서비스를 제공합니다.</p>
				</div>
				<div class="subTitle">
					<h3>주요 서비스</h3>
				</div>
